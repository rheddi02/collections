...
import type { coinOutput } from "~/server/api/client/types";
...
const PageTableCoin = ({
  ...
  data: coinOutput[]
  onDelete: (row: Row<coinOutput>) => void;
  onRowClick: (row: Row<coinOutput>) => void;
  onEdit: (row: Row<coinOutput>) => void;
  loading: boolean;
}) => {
  ...
  const columns: ColumnDef<coinOutput>[] = [
    {
      accessorKey: "id",
    },
    {
  ...
  // const onRowDivClick = (row: Row<coinOutput>) => {
